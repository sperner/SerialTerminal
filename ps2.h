...
#define LOOP_UNTIL_BIT_IS_SET(sfr, bit)    do {} while (BIT_IS_CEAR(sfr, bit))
...
#define CLK	7  // pin on CLKPORT for CLK line
#define DATA	6  // pin on DATAPORT for DATA line
...
void _delay(long microseconds);   // Function for internal usage
