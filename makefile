...
ifeq ($(MCU), atmega16)
	FUSE_BITS = -u -U lfuse:w:0xe4:m -U hfuse:w:0xdf:m
...
SRC =  main.c
SRC += uart.c
SRC += sed1335.c sed1335-avr.c
#SRC += graphic.c
SRC += ps2.c keyboard.c
...
#AVRDUDE_WRITE_FLASH += $(FUSE_BITS)
#AVRDUDE_WRITE_EEPROM = -U eeprom:w:$(TARGET).eep

#AVRDUDE_FLAGS = -p $(MCU) -P $(AVRDUDE_PORT) -b 115200 -c $(AVRDUDE_PROGRAMMER)
AVRDUDE_FLAGS = -p $(MCU) -E noreset -P $(AVRDUDE_PORT) -c $(AVRDUDE_PROGRAMMER)
